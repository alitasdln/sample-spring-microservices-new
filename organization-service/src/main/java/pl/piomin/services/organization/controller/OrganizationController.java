...
public class OrganizationController {
	...
	@Operation(summary = "Find an organization by id with all its departments")
	...
	@Operation(summary = "Find an organization by id with departments and employees")
	...
	@Operation(summary = "Find an organization by id with employees")
