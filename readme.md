...
**Changelog by Ali Tasdelen:**

- Fixed issues with "piomin/*" Docker images, which are no longer publicly available.
- Added 2 Docker Compose files for local image creation or importing from Docker Hub.
- Improved documentation for REST endpoints.
- Enabled Swagger UI where applicable.
